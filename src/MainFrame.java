/*
 Main Driver Code File
 Please run the project from here
 */
...
public class MainFrame extends JFrame 
{
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					//Set relative location and visibility 
					// of frame
	...
	public MainFrame() 
	{
		...
		// How to play button that links 
		// the Main Frame to the How to Play Page
