...
public class HowToPlay extends JFrame 
{
	...
	{	
		...
		//Create label that will title the frame 
		// for the user while adding styles
		JLabel HTP_Header = new JLabel("How to Play");
		HTP_Header.setForeground(new Color(0, 51, 153));
		HTP_Header.setBounds(312, 143, 279, 88);
		HTP_Header.setHorizontalAlignment
		(SwingConstants.CENTER);
		HTP_Header.setFont
		(new Font("Comic Sans MS", Font.PLAIN, 50));
		...
		//Create a DONE button that will take the user 
